...
if(isset($_GET['id']) AND !empty($_GET['id']))  {
    ...
    $salaire = $article['salaire'];
    $profil = $article['profil'];
    $contrat = $article['contrat'];
    $mail_contact = $article['mail_contact'];
	} else  {
		die('Cet article n\'existe pas');
	}

} else {
	header('Location:accueil.php'); /* SI ¨PROBLEME REMPLACER PAR :  ////    die('Erreur'); //////  */
}
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <table cellspacing="0" cellpadding="0" border="3" bordercolor="black" width="40%" align="center">
          <tr>
            <td width="20%"><b>Poste</b></td>
            <td width="50%" border="1">&nbsp;<?php echo $article['titre']; ?></td>
          </tr>
          <tr>
            <td width="20%"><b>Type de contrat</b></td>
            <td width="50%">&nbsp;<?php echo $article['contrat']; ?></td>
          </tr>
          <tr>
            <td width="20%"><b>Salaire</b></td>
            <td width="50%">&nbsp;<?php echo $article['salaire']; ?></td>
          </tr>
          <tr>
            <td width="20%"><b>Missions</b></td>
            <td width="50%">&nbsp;<?php echo $article['contenu']; ?></td>
          </tr>
          <tr>
            <td width="20%"><b>Profil recherché</b></td>
            <td width="50%">&nbsp;<?php echo $article['profil']; ?></td>
          </tr>
          <tr>
            <td width="20%"><b>Mail de l'annonceur</b></td>
            <td width="50%">&nbsp;<?php echo $article['mail_contact']; ?> <a href="envoi.php?mail=<?php echo $article['mail_contact'] ?>"><img width="40" height="40" src="img/send.png"></a></td>
          </tr>
        </table>

...
<html lang="fr">
  ...
  <head>
    ...
    <div align="center">
      <br/>
	<a href="envoi.php"><img src="img/enveloppe.png" width="60" heigth="60"></a> <br/> <br/> 
	...
	<?php if($m['lu'] == 1) { ?>  <span style="color:green"><i>Lu</i></span> <?php } ?> <b><?= $mail_exp ?></b> vous a envoyé <a href="lecture.php?id=<?= $m['id'] ?>">un message</a> <br/><br/>
	<b>Objet: </b></a><?= $m['objet'] ?><br/>
	-------------------------<br/>
	<?php } ?>
	</div>
